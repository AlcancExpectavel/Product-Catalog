...
// Para alterar: substitui [MARCA], [EMAIL], [TELEFONE], redes sociais, etc.
// =======================================================

import Link from "next/link";

const BRAND_NAME = "[MARCA]"; // ← Mesmo placeholder da Navbar
    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              {/* Substitui pela descrição curta da tua empresa */}
          ...
          <div>
            ...
            <div className="flex gap-3 mt-5">
              {/* Instagram — substitui o href pelo teu link */}
              ...
              {/* Facebook — substitui o href pelo teu link */}
              <a href="#" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 bg-gray-800 hover:bg-brand-600 rounded-lg flex items-center justify-center transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-10 pt-6 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs text-gray-500">
          ...
          <p>Desenvolvido com Next.js + Firebase</p>
        </div>
      </div>
    </footer>
  );
